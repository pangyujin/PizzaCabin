...
<body>
  <div class="wrapper">
    ...
    <div class="main">
      <div class="sidebar">
        <ul>
          <li><a href="pizza.php"><img src="../static/img/icon/pizza_icon.png" alt="pizza" style="height: 50px; width: 50px;"><br />Pizza</a></li>
          <li><a href="sides.php"><img src="../static/img/icon/fries_icon.png" alt="sides" style="height: 50px; width: 50px;"><br />Sides</a></li>
          <li><a class="active" href="beverage.php"><img src="../static/img/icon/drink_icon.png" alt="drink" style="height: 50px; width: 40px;"><br />Beverage</a></li>
        </ul>
      </div>
      <div class="container">
        ...
        <?php
          $beverage_query = "SELECT * 
                          ...
                          WHERE F.category = 'beverage' ";
          $beverage_result = $db->query($beverage_query);

          $beverage_list = array();
          for($i=0; $i<$beverage_result->num_rows; $i++) {
            $row = $beverage_result->fetch_assoc();
            $item = new FoodDAO($row['category'], $row['name'], $row['photo'], $row['price'], $row['description']);
            $beverage_list[] = $item;
          }

          foreach($beverage_list as $beverage) {
            $beverage->render_food();
          }
        ?>
